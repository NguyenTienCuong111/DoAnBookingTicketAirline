...
const {register, login, uploadAvatar, getAllTrip, getAllUser, getDetailUser, updateUser, deleteUser, updateUserBooking, ForgotPass,ResetPass} = require("../controllers/user.controllers");
