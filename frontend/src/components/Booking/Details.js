	...
	const data = [
		{
			title: (
				<div className="img-name flex items-center">
					<img src="https://static.vexere.com/production/utilities/1610093076560.png" alt="" width={32} height={32} className="mr-2" />
					<div className="name">An toàn là trên hết</div>
				</div>
			),
			description: (
				<div className="description">
					(1) Làm theo hướng dẫn của phi hành đoàn
					<br />
					(2) Thắt dây an toàn đúng cách
					<br />
					(3) Không mang theo hành lý quá cồng kềnh
				</div>
			),
		},
		{
			title: (
				<div className="img-name flex items-center">
					<img src="https://static.vexere.com/production/utilities/1609837962216.png" alt="" width={32} height={32} className="mr-2" />
					<div className="name">Kiểm tra nghiêm ngặt</div>
				</div>
			),
			description: <div className="description">Mọi thông tin đều được quét và kiểm tra nghiêm ngặt qua các cổng kiểm tra từ tính</div>,
		},
		{
			title: (
				<div className="img-name flex items-center">
					<img src="https://static.vexere.com/production/utilities/1609837921462.png" alt="" width={32} height={32} className="mr-2" />
					<div className="name">Khu vệ sinh</div>
				</div>
			),
			description: <div className="description">Với các khoang trong máy bay đều có các nhà vệ sinh riêng</div>,
		},
		{
			title: (
				<div className="img-name flex items-center">
					<img src="https://static.vexere.com/production/utilities/1609837906714.png" alt="" width={32} height={32} className="mr-2" />
					<div className="name">Nhiệt độ</div>
				</div>
			),
			description: <div className="description">Nhiệt độ bên trong đều được cân bằng tốt và giữ không khí cho hành khách</div>,
		},
	];
	const settings = {
		dots: true,
