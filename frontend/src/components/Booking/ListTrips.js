						...
						<div className="grid grid-cols-12" style={{minHeight: "180px"}}>
							<div className="col-span-3 logo-trips">
								<div className="image" style={{position: "relative"}}>
									...
									<img className="sticker ls-is-cached lazyloaded" data-src="https://storage.googleapis.com/fe-production/images/sticker-covid.png" alt="chuyến bay an toàn" src="https://storage.googleapis.com/fe-production/images/sticker-covid.png" />
									...
									<div className="bus-name">
										...
										<button type="button" className="ant-btn bus-rating-button">
											<div className="bus-rating">
												<StarFilled />
												<span>
													{!isNaN(avgRatePassenger) && avgRatePassenger} {item?.passenger?.passengerRate.length == 0 ? "" : item?.passenger?.passengerRate?.length}
												</span>
											</div>
										</button>
									</div>
	...
	return (
		<div className="list_trips">
			<div className="trip-style">
				<h1 id="seo-heading">
					Đặt mua vé máy bay {tripRender.toStation} từ {tripRender.fromStation} chất lượng cao và giá vé ưu đãi nhất :{listTripPassenger.filter((item) => item.status == "depart").length} chuyến
				</h1>
				<div className="sort">
