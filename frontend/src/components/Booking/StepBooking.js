			...
			{isLoadingSpin ? (
				...
				<>
					<div class="TrustMessage__Container-sc-8xur6b-0 deVKGv trust-message-container undefined" style={{color: "rgb(14, 99, 193)"}}>
						<p class="base__Body02-sc-1tvbuqk-14 VqdXU trust-message-content">Flight Booking cam kết giữ đúng vị trí bạn đã chọn.</p>
					</div>
				...
				<div style={{margin: "auto", width: 400}}>
					<Form {...layout} name="nest-messages" onFinish={onFinish} validateMessages={validateMessages}>
						...
						<Form.Item name={["user", "introduction"]} label="Ghi chú">
							<Input.TextArea placeholder="Các yêu cầu đặc biệt không thể được đảm bảo - nhưng Hãng bay sẽ cố gắng hết sức để đáp ứng nhu cầu của bạn." onChange={handleChangeNote} />
						</Form.Item>
					</Form>
				</div>
			</div>
