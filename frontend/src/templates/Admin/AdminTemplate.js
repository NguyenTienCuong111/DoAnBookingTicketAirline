						...
						<Layout style={{minHeight: "100vh"}}>
							<Sider collapsible collapsed={collapsed} onCollapse={changeCollapsed}>
								<div className="logo flex justify-center items-center mt-5">
									<img src="https://png.pngtree.com/template/20190214/ourmid/pngtree-circle-travel-plane-logo-template-in-blacn-and-white-image_55579.jpg" alt={123} width={33}  height={33} className="mb-5" />
								</div>
