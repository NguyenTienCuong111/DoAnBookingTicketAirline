					...
					<div className="grid grid-cols-1">
						<div className="logo">
							<a href={"http://localhost:3000"}>
								<img src="https://png.pngtree.com/template/20190214/ourmid/pngtree-circle-travel-plane-logo-template-in-blacn-and-white-image_55579.jpg" alt="logo" width={50} height={50} />
							</a>
						</div>
					</div>
				</div>
						...
						<div className="col-span-4">
							...
							<Card style={{width: "100%", height: "auto", border: " 1px solid rgb(192, 192, 192)"}}>
								<div className="table-info">
									...
									<div className="edit-info">
										<div className="label">Hãng bay</div>
									</div>
